...
var lyr_Refactored_0 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Refactored<br />\
    <img src="styles/legend/Refactored_0_0.png" /> 0 - 4.6<br />\
    <img src="styles/legend/Refactored_0_1.png" /> 4.6 - 6.5<br />\
    <img src="styles/legend/Refactored_0_2.png" /> 6.5 - 13.9<br />\
    <img src="styles/legend/Refactored_0_3.png" /> 13.9 - 20<br />\
    <img src="styles/legend/Refactored_0_4.png" /> 20 - 74.5<br />'
        });

lyr_Refactored_0.setVisible(false);
var layersList = [lyr_Refactored_0];
lyr_Refactored_0.set('fieldAliases', {'ID_0': 'ID_0', 'ISO': 'ISO', 'NAME_0': 'NAME_0', 'ID_1': 'ID_1', 'NAME_1': 'NAME_1', 'TYPE_1': 'TYPE_1', 'ENGTYPE_1': 'ENGTYPE_1', 'NL_NAME_1': 'NL_NAME_1', 'VARNAME_1': 'VARNAME_1', 'ue in india_Date': 'ue in india_Date', 'Estimated Unemployment Rate (%)': 'Estimated Unemployment Rate (%)', 'Estimated Employed': 'Estimated Employed', 'Estimated Labour Participation Rate (%)': 'Estimated Labour Participation Rate (%)', 'Area': 'Area', });
