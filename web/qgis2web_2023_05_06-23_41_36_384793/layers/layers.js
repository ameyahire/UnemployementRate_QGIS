...
lyr_Refactored_0.set('fieldAliases', {'ID_0': 'ID_0', 'ISO': 'ISO', 'NAME_0': 'NAME_0', 'ID_1': 'ID_1', 'NAME_1': 'NAME_1', 'TYPE_1': 'TYPE_1', 'ENGTYPE_1': 'ENGTYPE_1', 'NL_NAME_1': 'NL_NAME_1', 'VARNAME_1': 'VARNAME_1', 'Date': 'Date', ' Estimated Unemployment Rate (%)
...
': ' Estimated Labour Participation Rate (%)
', 'Area': 'Area', });
lyr_Refactored_0.set('fieldImages', {'ID_0': 'TextEdit', 'ISO': 'TextEdit', 'NAME_0': 'TextEdit', 'ID_1': 'TextEdit', 'NAME_1': 'TextEdit', 'TYPE_1': 'TextEdit', 'ENGTYPE_1': 'TextEdit', 'NL_NAME_1': 'TextEdit', 'VARNAME_1': 'TextEdit', 'Date': 'TextEdit', ' Estimated Unemployment Rate (%)
': 'TextEdit', ' Estimated Employed
': 'TextEdit', ' Estimated Labour Participation Rate (%)
': 'TextEdit', 'Area': 'TextEdit', });
lyr_Refactored_0.set('fieldLabels', {'ID_0': 'no label', 'ISO': 'no label', 'NAME_0': 'no label', 'ID_1': 'no label', 'NAME_1': 'inline label', 'TYPE_1': 'no label', 'ENGTYPE_1': 'no label', 'NL_NAME_1': 'no label', 'VARNAME_1': 'no label', 'Date': 'inline label', ' Estimated Unemployment Rate (%)
': 'inline label', ' Estimated Employed
': 'inline label', ' Estimated Labour Participation Rate (%)
